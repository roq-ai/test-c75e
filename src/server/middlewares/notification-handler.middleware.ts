...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'engineer.create': {
    ...
    key: 'engineer-added',
    tenantPath: ['organization', 'engineer'],
    userPath: [],
  },
  'engineer.delete': {
    roles: ['business-owner'],
    key: 'engineer-removed',
    tenantPath: ['organization', 'engineer'],
    userPath: [],
  },
  'hiring_request.create': {
    roles: ['business-owner'],
    key: 'hiring-request-received',
    tenantPath: ['organization', 'engineer', 'hiring_request'],
    userPath: [],
  },
  'hiring_request.update': {
    roles: ['business-owner'],
    key: 'hiring-request-status-updated',
    tenantPath: ['organization', 'engineer', 'hiring_request'],
    userPath: [],
  },
  'engineer.update': {
    roles: ['business-owner', 'engineer'],
    key: 'engineer-profile-updated',
    tenantPath: ['organization', 'engineer'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'engineer'];
