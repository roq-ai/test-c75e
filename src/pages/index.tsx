  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Test - Your Ultimate Platform for Showcasing Engineering Talent and Connecting Companies for Successful Collaborations."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1664575196644-808978af9b1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2V8ZW58MHx8fHwxNjk0Mzc2MTAwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Test - Your Ultimate Platform for Showcasing Engineering Talent and Connecting Companies for Successful Collaborations.`}
            </Text>
            <Box
