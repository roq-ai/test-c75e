...
import { getEngineerById } from 'apiSdk/engineers';
import { EngineerInterface } from 'interfaces/engineer';
import { HiringRequestListPage } from 'pages/hiring-requests';

function EngineerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('engineer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/engineers/edit/${id}`} passHref legacyBehavior>
                    <Button
